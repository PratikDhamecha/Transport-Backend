...
exports.registerSingleOwner = async (req,res,next) =>{
    try{
        ...
        let tokenData = {singleOwnerId:createdSingleOwner._id,singleOwner_email:createdSingleOwner.singleOwner_email,singleOwner_password:createdSingleOwner.singleOwner_Password,singleOwner_categoryId:createdSingleOwner.categorySingleOwner_Id};
